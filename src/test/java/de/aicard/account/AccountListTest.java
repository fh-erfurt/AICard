...
public class AccountListTest {
    ...
    public void testAddRemoveFromAccountList()
    {
        ...
        Professor Prof2 = new Professor("Prof@fh-erfurt.de","adminProf","Prof","Professor", AcademicGrade.A);
        Professor Prof3 = new Professor("Prof2@fh-erfurt.de","adminProf2","Prof2","Professor2", AcademicGrade.B);
