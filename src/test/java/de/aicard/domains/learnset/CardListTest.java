...
public class CardListTest
{
    ...
    public void testingCardListConstructors()
    {
        ...
        Card Card1 = new Card(new CardContent(), new CardContent());
        Card Card2 = new Card(new CardContent(), new CardContent());
    ...
    public void testingCardListGetNextPrevious()
    {
        ...
        Card Card1 = new Card(new CardContent(), new CardContent());
        Card Card2 = new Card(new CardContent(), new CardContent());
        Card Card3 = new Card(new CardContent(), new CardContent());
